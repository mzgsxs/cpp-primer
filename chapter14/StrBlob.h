...
friend bool operator == (StrBlob const &, StrBlob const &);
friend bool operator < (StrBlob const & lhs, StrBlob const & rhs);
...
bool operator == (StrBlob const & lhs, StrBlob const & rhs){
  return *lhs.sp_data == *rhs.sp_data;
}
